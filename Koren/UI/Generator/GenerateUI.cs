...
public static partial class GenerateUI {
    ...
    public static UISlider Slider(
        ...
        // Commit on Enter or focus loss. Either way: parse → apply through
        // the filter → call OnComplete → refresh display to show the
        // formatted (possibly clamped/snapped) result.
